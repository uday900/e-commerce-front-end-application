...
const AddProduct = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            // Append all the form data except for the imageFile
            ...
            // Append the image if available (uncomment if you need to send the image)
            // if (data.imageFile && data.imageFile[0]) {
            //     formData.append("imageFile", data.imageFile[0]);
            // }
    
            // Sending the request to the correct category endpoint
